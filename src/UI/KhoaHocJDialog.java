...
public class KhoaHocJDialog extends javax.swing.JDialog {
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtngayKG, javax.swing.GroupLayout.DEFAULT_SIZE, 322, Short.MAX_VALUE)))
    ...
    private void init() {
        ...
        txtNgayTao.setText(dtf.format(now));
...
txtHocPhi.setText(String.valueOf(kh.getHocPhi()));
    ...
    KhoaHoc getForm() {
        ...
        System.out.println("thoi luong" + txtThoiLuong.getText());
        kh.setNgayKG(txtngayKG.getDate());
        kh.setHocPhi(Double.parseDouble(txtHocPhi.getText()));
        System.out.println("hp" + txtHocPhi.getText());
...
void first() {
    ...
    boolean validated() {
        ...
        if (!isValidated.isBlank(hocphi)) {
            ...
            notice = "Vui lòng nhập học phí ";
            return false;
        }

        if (!isValidated.isBlank(thoiluong)) {
            txtThoiLuong.requestFocus();
            notice = "Vui lòng nhập thời lượng";
            return false;
        }
        return true;
    }
