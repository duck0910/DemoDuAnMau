...
public class NguoiHocJDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        txtMaNH.setText("PC07108");

        lblHoVaTen.setText("Họ và tên");

        txtHoVaTen.setText("Dương Tuyết Ngân");
        ...
        txtDienThoai.setText("0935281654");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtNgaySinh, javax.swing.GroupLayout.DEFAULT_SIZE, 470, Short.MAX_VALUE)
    ...
    boolean validated() {
        ...
        if (!isValidated.isBlank(manh)) {
            txtMaNH.requestFocus();
            notice = "Vui lòng nhập mã người học";
            return false;
        }

        if (!isValidated.isBlank(hovaten)) {
            txtHoVaTen.requestFocus();
            notice = "Vui lòng nhập họ và tên";
            return false;
        }

        if (!isValidated.isBlank(dienthoai)) {
            txtDienThoai.requestFocus();
            notice = "Vui lòng nhập số điện thoại của bạn";
            return false;
        }
        if (!isValidated.isBlank(email)) {
            txtEmail.requestFocus();
            notice = "Vui lòng nhập email của bạn";
            return false;
        }
